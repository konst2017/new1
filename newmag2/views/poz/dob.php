					...
					<div class="col-md-9 col-xs-12">
						...
						<div class="product-banner">
							<div class="row">
								<div class="col-xs-12">
									<div class="banner">
										<a href="#"><img src="/web/img/banner/12.jpg" alt="Product Banner"></a>
									</div>
								</div>
							</div>
						</div>
    ...
    <div class="product-image-wrapper">
        <div class="single-products">
            <div class="productinfo text-center">
                <?= Html::img("@web/web/images/products/{$product->img}", ['alt' => $hit->name])?>
                <h2>$<?= $product->price?></h2>
        ...
        <div class="choose">
            <ul class="nav nav-pills nav-justified">
                 <li><a href="#"><i class="fa fa-plus-square"></i>Добавить в список пожеланий</a></li>
